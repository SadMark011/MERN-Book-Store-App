...
const Register = () => {
    ...
    // Form Validation and Data handling using React Hook Form
    const {
        register,
        handleSubmit,
        watch,
        ...
        shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='mb-4'>
                    ...
                    <input 
                    {...register("email", { required: true })}                                //React Hook Form
                ...
                <div className='mb-4'>
                    ...
                    <input 
                    {...register("password", { required: true })}                                //React Hook Form
                    type="password" name='password' id='password' placeholder='Enter Your Password'
                    className='shawdow appearance-none border rounded w-full py-2 px-3 
                    leading-tight focus:outline-none focus:shadow'/>
                </div>

                {/* In case password or email is invalid */}
                {
            ...
            <div className='mt-3'>
                ...
                hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none'>
                    ...
                    <FaGoogle className='mr-2 mb-0.5'/> Sign In with Google
                </button>
            </div>

            <p className='mt-5 text-center text-gray-500 text-xs '>02025 Book Store. All rights reserved</p>
